...
: ${AMENT_CURRENT_PREFIX:="/home/zoellickhan/Code/testing/install/test_serialdriver"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_serialdriver/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_serialdriver/environment/path.sh"
